...
namespace NetQuestion.Infrastructure.Postgres.Repositories;
...
public class QuestionsEfCoreRepository : IQuestionsRepository
{
    ...
    public Task<int> GetOpenUserQuestionsAsync(Guid questionDtoUserId, CancellationToken cancellationToken) => throw new NotImplementedException();
}